...
def cs_sidebar():
    ...
    st.sidebar.markdown('''[<img src='data:image/png;base64,{}' class='img-fluid' width=32 height=32>](https://streamlit.io/)'''.format(img_to_bytes("streamlit-cheatsheet\logomark_website.png")), unsafe_allow_html=True)
...
pip install streamlit-nightly --upgrade
    ...
    st.sidebar.markdown('''<small>[Cheat sheet v1.25.0](https://github.com/daniellewisDL/streamlit-cheat-sheet)  | June 2024 | [Deependra Mishra](https://daniellewisdl.github.io/)</small>''', unsafe_allow_html=True)
